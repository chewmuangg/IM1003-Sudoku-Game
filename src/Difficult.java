...
public class Difficult extends GameLayouts {
	...
	// Opens 7 cells, different numbers
				...
				for (int col = 0; col < GRID_SIZE && !found; ++col) {
					...
					if (tfCells[row][col] == source) {
						...
						if (input == puzzle[rowSelected][colSelected]) {
							tfCells[row][col].setBackground(OPEN_CELL_TEXT_YES); // set background to Green on correct
																					// guess
